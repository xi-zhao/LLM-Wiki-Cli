...
class WikifyCliTests(unittest.TestCase):
    ...
    def test_docs_describe_human_ingest_and_machine_pipeline_boundary(self):
        ...
        self.assertIn('Turn links, files, repos, and notes into an agent-maintained local wiki.', readme)
        self.assertIn('Why Star Wikify?', readme)
        self.assertIn('30-Second Demo', readme)
        self.assertIn('For OpenClaw, Codex, Claude Code, and shell agents', readme)
        self.assertIn('Human wiki', readme)
        self.assertIn('Agent memory', readme)
        self.assertIn('Recovery layer', readme)
        self.assertIn('Not another notes app. Not another chat RAG demo.', readme)
        self.assertIn('Deep Docs', readme)
