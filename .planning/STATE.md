...
- [Phase 28 planning]: Existing graph maintenance commands and artifacts remain the compatibility anchor; v0.2 maintenance metadata should be additive and optional.
